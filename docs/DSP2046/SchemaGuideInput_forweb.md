...
<p><b>Document Class: Informative</b></p>
<p><b>Document Status: <span class="status">Published</span></b></p>
<p><b>Document Language: en-US</b></p>
<br>
   <p>Copyright Notice</p>
    <p>Copyright &copy; 2016-2018 Distributed Management Task Force, Inc. (DMTF). All rights reserved.</p>
<br><br>
...
As shown in the example, a Redfish Service may provide management functionality for several Computer Systems, and therefore a ComputerSystemCollection resource is provided.  This example shows a Service with four ComputerSystem instances ("Members").
